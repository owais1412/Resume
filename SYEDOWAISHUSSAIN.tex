...
\begin{center}
    ...
    \vspace{5pt}
    \small \raisebox{-0.1\height}\faPhone\ +918602217822 ~
    \raisebox{-0.2\height}\faEnvelope\ \href{mailto:owes.hussain@gmail.com}{ owes.hussain@gmail.com} ~
    \raisebox{-0.2\height}\faLinkedin\ \href{https://www.linkedin.com/in/owais1412}{ linkedin.com/in/owais1412}  ~
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Technology in Computer Science, CGPA: 8.69}{Indore, Madhya Pradesh, India}
...
\resumeSubheading
  {ReleaseOwl Pvt. Ltd.}{Sep ’24 -- Present}
  {Software Engineer}{Bengaluru, Karnataka, India}
  \vspace{-7pt}
  \resumeItemListStart
    \resumeItem{Built and maintained a full-stack platform designed for enterprise architects to streamline application development.}
    \resumeItem{Ensured system reliability by fixing critical bugs and optimizing database and backend performance.}
    \resumeItem{Reviewed code and mentored team members to uphold quality and best practices.}
    \resumeItem{Automated deployments and improved CI/CD workflows on Cloud Foundry.}
  \resumeItemListEnd
  \vspace{4pt}
  \textbf{Skills}: HTML, CSS, Javascript, Sveltejs, Golang, PostgreSQL.

\resumeSubheading
      {Biofourmis India Pvt. Ltd.}{Mar ’22 -- Sep ’24}
      {Software Engineer}{Bengaluru, Karnataka, India}
      \vspace{-7pt}
      \resumeItemListStart
        \resumeItem{Solely responsible and had ownership of multiple features and modules.}
\resumeItem{Built vendor dashboard system significantly improved communication and transparency between our platform, vendors, and patients.}
\resumeItem{Average service acceptance rate increased by 25\% due to real-time request updates and improved visibility.}
\resumeItem{Vendor response time decreased by 20\% due to efficient service management tools.}
\resumeItem{Patient satisfaction with increased by 15\% due to improved communication and responsiveness.}
\resumeItemListEnd
\vspace{4pt}
\textbf{Skills}: Golang, Node.js, NoSQL, MongoDB, Redis, Microservices.


    \resumeSubheading
      {HashCube Software Pvt. Ltd.}{Jan ’21 -- Mar ’22}
      {Software Engineer}{Bengaluru, Karnataka, India}
      \vspace{-7pt}
      \resumeItemListStart
