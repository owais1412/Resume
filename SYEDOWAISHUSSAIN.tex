...
\resumeSubheading
      ...
      \vspace{-7pt}
      \resumeItemListStart
        \resumeItem{Plan, Build, and Architect the Backend APIs and microservices.}
\resumeItem{Take care of new features in the system.
}
\resumeItem{Direct point of contact for QA and dev teams for fixes or changes.
}
\resumeItem{ Solely responsible and had ownership of multiple features and modules.}
\resumeItemListEnd
\vspace{4pt}
\textbf{Skills}: Golang, Node.js, NoSQL, Redis, Microservices.
